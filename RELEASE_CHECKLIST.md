...
One-time setup, ~10 minutes total. Replace USERNAME with your GitHub username throughout.
...
git branch -M main
git remote add origin https://github.com/USERNAME/mixtriad.git
...
2. GitHub -> Settings -> flip the switch next to `USERNAME/mixtriad` (the shipped
...
## 3. Update three files with the final links (search for "USERNAME" / "zenodo")
- Manuscript Table 1, field C2:  https://github.com/USERNAME/mixtriad/tree/v1.0.0
