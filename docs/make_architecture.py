...
def box(x, y, w, h, title, lines, fc):
    ...
    for i, l in enumerate(lines):
        ax.text(x + w/2, y + h - 6.6 - 3.4*i, l, ha="center", va="center", fontsize=7.8)
...
box(2, 6, 20, 16, "data module", ["schema validation", "log1p transforms",
                                  "Krippendorff's \u03b1", "for hand-coded vars"], "#F5F5F5")
arrow(12, 30, 12, 23.6)

# stage 1
box(27, 28, 21, 20, "Stage 1 \u00b7 regression", ["OLS on log outcome", "(HC1 robust SE)",
                                     "negative binomial", "robustness model", "VIF diagnostics"], "#FDEBD0")
# stage 2
box(52, 28, 21, 20, "Stage 2 \u00b7 boosting", ["5\u00d7 repeated 80/20", "hold-out (fixed seeds)",
                                    "TPE-tuned XGBoost", "permutation importance", "elbow condition screen"], "#E8F6E8")
# stage 3
box(77, 28, 21, 20, "Stage 3 \u00b7 fsQCA", ["direct calibration", "necessity analysis",
...
box(31, 4, 62, 15, "Outputs (per stage, written to disk)",
    ...
    "#FFF8DC")
arrow(37.5, 27.4, 45, 19.6); arrow(62.5, 27.4, 62, 19.6); arrow(87.5, 27.4, 79, 19.6)
